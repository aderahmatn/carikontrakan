    ...
    <div class="col-6">
        <div class="card">
            ...
            <form role="form" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
                <input type="hidden" value="<?= $pemilik->id_owner ?>" name="fid_owner">
                <div class="card-body">
                    <div class="form-group">
                        <label for="fnama_kontrakan">Nama Pemilik</label>
                        <input type="text" class="form-control <?= form_error('fnama_pemilik') ? 'is-invalid' : '' ?>" id="fnama_pemilik" name="fnama_pemilik" placeholder="Nama pemiliik kontrakan" value="<?= $pemilik->nama_owner ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('femail') ? 'is-invalid' : '' ?>" id="femail" name="femail" placeholder="Email pemilik" value="<?= $pemilik->email ?>">
                        <div class="invalid-feedback">
                            <?= form_error('femail') ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('fhandphone') ? 'is-invalid' : '' ?>" id="fhandphone" name="fhandphone" placeholder="Nomor handphone" value="<?= $pemilik->handphone ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="falamat" id="falamat" class="form-control <?= form_error('falamat') ? 'is-invalid' : '' ?>" cols="10" rows="5" placeholder="Enter Deskripsi Alamat"><?= $pemilik->alamat ?></textarea>
                        <div class="invalid-feedback">
                            <?= form_error('falamat') ?>
                        </div>
                    </div>
