    ...
    <div class="col-6">
        <div class="card">
            ...
            <form role="form" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
                <input type="hidden" name="fid_admin" value="<?= $admin->id_admin ?>">
                <div class="card-body">
                    <div class="form-group">
                        <label for="fnama_kontrakan">Nama Admin</label>
                        <input type="text" class="form-control <?= form_error('fnama_admin') ? 'is-invalid' : '' ?>" id="fnama_admin" name="fnama_admin" placeholder="Nama administrator" value="<?= $admin->nama_admin ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('femail') ? 'is-invalid' : '' ?>" id="femail" name="femail" placeholder="Email pemilik" value="<?= $admin->email ?>">
                        <div class="invalid-feedback">
                            <?= form_error('femail') ?>
                        </div>
                    </div>
